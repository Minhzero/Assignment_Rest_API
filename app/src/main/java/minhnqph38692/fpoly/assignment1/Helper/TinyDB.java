...
public class TinyDB {
    ...
    public ArrayList<FoodDTO> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FoodDTO> playerList =  new ArrayList<FoodDTO>();

        for(String jObjString : objStrings){
            FoodDTO player  = gson.fromJson(jObjString,  FoodDTO.class);
    ...
    public void putListObject(String key, ArrayList<FoodDTO> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FoodDTO player: playerList){
